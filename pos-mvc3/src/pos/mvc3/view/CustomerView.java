...
//    }
    ...
    private void addCustomer(){
        ...
        Customer customer = new Customer(id,name,address,email,postalCode);
    ...
    private void loadCustomers() {
        try {
            ...
            for(Customer customer : customers){
                String[] rowData = {Integer.toString(customer.getId()), customer.getName(), customer.getEmail(),customer.getAddress(), customer.getPostalCode()};
                dtm.addRow(rowData);
            }
