...
import pos.mvc3.controller.CustomerController;
import pos.mvc3.controller.ItemController;
import pos.mvc3.controller.Ordercontroller;
...
//    }
    ...
    private void searchCustomer() {
        try {
            Customer customer = customerController.getCustomer(Integer.parseInt(txtCustomerID.getText()));
            if(customer != null){
    ...
    private void serachItem() {
        try {
            Item item = itemController.getItem(Integer.parseInt(txtItemID.getText()));
            if( item != null){
    ...
    private void addToTable() {
        if(tempItem != null){
           OrderDetail od = new OrderDetail(-1,tempItem.getId(),Integer.parseInt(txtQuantity.getText()), tempItem.getUnitPrice(),tempItem.getName());
           orderDetails.add(od);
    ...
    private void placeOrder() {
        Order order = new Order(Integer.parseInt(txtOrderID.getText()), tempCustomer.getId(), new Date(), total);
